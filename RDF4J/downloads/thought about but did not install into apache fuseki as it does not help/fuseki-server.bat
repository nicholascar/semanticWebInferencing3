...
set "libraries=lib\*;lib\jgrapht-1.1.0\*"

@echo off
@REM modify this to name the server jar
@rem java -Xmx1200M -jar fuseki-server.jar -classpath %*
%java% -Xmx1200M -classpath fuseki-server.jar;%libraries% org.apache.jena.fuseki.cmd.FusekiCmd %*
pause
